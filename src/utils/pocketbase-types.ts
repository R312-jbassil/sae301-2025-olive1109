...
export enum CommandeStatutOptions {
	"en_preparation" = "en_preparation",
	"en_livraison" = "en_livraison",
	"livrer" = "livrer",
}
export type CommandeRecord = {
	Lunette?: RecordIdString[]
	created: IsoAutoDateString
	date_commande?: IsoDateString
	id: string
	prix?: number
	statut?: CommandeStatutOptions
	updated: IsoAutoDateString
}

export type LunetteRecord<Tsvg_code = unknown> = {
	created: IsoAutoDateString
	date?: IsoDateString
	id: string
	nom_model?: string
	svg_code?: null | Tsvg_code
	updated: IsoAutoDateString
...
export type MateriauRecord = {
	...
	id: string
	libelle?: string
	type?: MateriauTypeOptions
	updated: IsoAutoDateString
}

export type UtiliseRecord = {
	created: IsoAutoDateString
	id: string
	lunette?: RecordIdString
